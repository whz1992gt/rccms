<?php
$data = array (
  'personal_talent_requirement' => '<p>&nbsp;&nbsp;&nbsp; 企业的HR对高级人才的关注度比普通人才高很多，即使现阶段企业并不需要这样的高级人才但当HR发现这样的人才时也会进行一定关注。所以一分完整的高级简历往往能让更多的HR发现你、关注你，让你拥有更多的机会。</p>
<p>&nbsp;&nbsp; 一份高级简历中工作经历和您在工作中取得的成绩是非常重要的，如果您有比较重要的成绩请不要省略。同时如果有一些比较权威的培训或在社会等地方获得有重大奖项也可以添加到您的简历中，这也会给您的简历增色不少。</p>',
  'agreement' => '<table class="ke-zeroborder" border="0" cellspacing="0" cellpadding="0" width="100%">
<tbody>
<tr>
