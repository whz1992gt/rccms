function tagso(templatedir,dir,jobslisturl,getarr)
{
	...
	opthtm+='<div class="zwss min colorh">';
	...
	if (get[4]=='')
	{
		...
		if(get[4] == arr[0]){
			scalename=arr[1];
			opthtm+='<li style="background:#f96400;border-radius:3px;color:#fff;text-decoration:none;"><span  id="jobtag-'+get[4]+'">'+scalename+'</span></li>';
		}else{
			opthtm+='<li><a href="'+href+'" id="jobtag-'+arr[0]+'"  class="opt">'+arr[1]+'</a></li>';
		}
		// opthtm+='<li class="kk"><a href="'+href+'" id="jobtag-'+arr[0]+'"  class="opt">'+arr[1]+'</a></li>';
		}
	}
	else
	{
	...
	if (get[0]=='')
	{
		...
		if(arr[0] == get[0]){
			categoryname = arr[1];
			opthtm+='<li style="background:#f96400;border-radius:3px;color:#fff;text-decoration:none;"><span  id="category-'+arr[0]+'"  class="opt" >'+arr[1]+'</span></li>';
		}else{
	...
	else
	{
		...
		for(var i=0;i<QS_jobs_parent.length;i++)
		{
			...
			if (arr[0]==get[0]){
				categoryname=arr[1];
				opthtm+='<li style="background:#f96400;border-radius:3px;color:#fff;text-decoration:none;"><span  id="category-'+get[0]+'">'+categoryname+'</span></li>';
			}else{
				opthtm+='<li><a href="'+href+'" id="category-'+arr[0]+'"  class="opt">'+arr[1]+'</a></li>';
			}
		}
		...
		if (subclassstr)//如果有子类
		{
				if (get[1]=='')
				{
					...
					if (len>0)
					{
							...
							if(get[1] == arr[0]){
								 opthtm+='<li style="background:#f96400;border-radius:3px;color:#fff;text-decoration:none;"><span  id="subclass-'+arr[0]+'"  class="opt">'+arr[1]+'</span></li>';
								}else{
				...
				else
				{
					...
					for(var i=0;i<arrsubclass.length;i++)
					{
						...
						if (arr[0]==get[1]){
							subclassname=arr[1];
							opthtm+='<li style="background:#f96400;border-radius:3px;color:#fff;text-decoration:none;"><span  id="subclass-'+get[1]+'">'+subclassname+'</span></li>';
						}else{
							opthtm+='<li><a href="'+href+'" id="subclass-'+arr[0]+'"  class="opt">'+arr[1]+'</a></li>';
						}
					}
	...
	if(get[2] == ''){
		...
		opthtm+='<div class="zwss colorh">';
				...
				arr    =arrsubclass[i].split(",");
				if(get[3]==arr[0]){ 
	            opthtm+='<li style="background:#f96400;border-radius:3px;color:#fff;text-decoration:none;"><span  id="sdistrict-'+arr[0]+'"  class="opt">'+arr[1]+'</span></li>';
	            }else{
