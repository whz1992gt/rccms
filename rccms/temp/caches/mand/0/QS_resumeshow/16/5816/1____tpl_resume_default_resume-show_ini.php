...
$(document).ready(function()
{
	...
	dialog("加为好友","url:get?/user/user_buddy.php?tuid=7865","350px","auto","");
	});
	$("#addpms").click(function(){
	var url="/user/user_pms.php?tuid=7865";
        ...
        <tr>
          <td><table cellpadding="0" cellspacing="0" style="width:100%">
              ...
              <tr>
                ...
                <td class="td-r">1年以下</td>
              </tr>
              <tr>
                <td class="td-l">联系地址：</td>
                <td class="td-r">福建省福州市</td>
      ...
      <div class="c0 m-t">
        ...
        <table cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
            ...
            <td class="td2">行政专员/助理,人事专员/助理,招聘专员/助理</td>
          </tr>
          <tr>
            <td class="td1">期望从事的行业：</td>
            <td class="td2">金融(银行/保险),房地产开发,物业管理/商业中心,教育/培训,酒店/旅游</td>
          </tr>
        </table>
      </div>
