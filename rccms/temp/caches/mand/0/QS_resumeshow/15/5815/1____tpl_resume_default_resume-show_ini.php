...
$(document).ready(function()
{
	...
	dialog("加为好友","url:get?/user/user_buddy.php?tuid=7889","350px","auto","");
	});
	$("#addpms").click(function(){
	var url="/user/user_pms.php?tuid=7889";
  ...
  <tr>
	...
	<a href="javascript:void(0)" id="newbuddy">加为好友</a>
      ...
      <table cellpadding="0" cellspacing="0" style="width:100%">
          <td style="width:80%" class="title"><h1>郑玉枝的个人简历</h1>
            <div class="res-info">更新时间：2014-07-21　会员编号：17207 　浏览次数：<span class="click"></span> 次</div></td>
        ...
        <tr>
          <td><table cellpadding="0" cellspacing="0" style="width:100%">
              ...
              <tr>
                ...
                <td class="td-r">郑玉枝</td>
                <td class="td-l">性　　别：</td>
                <td class="td-r">女</td>
              </tr>
              <tr>
                <td class="td-l">年　　龄：</td>
                <td class="td-r">22 岁</td>
                <td class="td-l">身　　高：</td>
                <td class="td-r">155CM</td>
              </tr>
              <tr>
    ...
    <div id="resume">
      ...
      <div class="c0 m-t">
        ...
        <table cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
            ...
            <td class="td2">人事专员/助理,招聘专员/助理</td>
          </tr>
          <tr>
            <td class="td1">期望从事的行业：</td>
            <td class="td2">消费品(食/饮/烟酒),教育/培训,交通/运输/物流,政府部门/事业单位</td>
          </tr>
        </table>
      </div>
      ...
      <div class="c1">
        <table cellpadding=0 cellspacing=0 border=0>
          <tr>
            ...
            <td class=td2>学习能力较好，能很快地掌握所需要的知识技能，并且在校期间参加了学生工作，有一定的组织协调能力，能较好地与他人进行沟通，并且有参加过一些关于销售的社会实习，能熟练使用office办公软件。
</td>
          </tr>
        </table>
      </div>
      ...
      <div class="c0">
        <table cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF" class="td2">2011年9月至2015年6月&nbsp;</td>
          </tr>
          <tr>
      ...
      <div class="c0">
        <table  cellpadding="0" cellspacing="0" border="0">
		    	                   <tr>
            <th colspan="2"  class="td1" style="text-align:left"><strong>福建龙岩闽西好食品有限公司</strong> - 门店销售</th>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td bgcolor="#FFFFFF" class="td2">福建龙岩闽西好食品有限公司</td>
          </tr>
          <tr>
            <th align="right" class="td1">从事职位：</th>
            <td bgcolor="#FFFFFF" class="td2">门店销售</td>
          </tr>
          <tr>
            <th align="right" class="td1">业绩表现：</th>
            <td bgcolor="#FFFFFF" class="td2">在工作的两个月期间，按时上下班，并且对待顾客态度热情，销售业绩也良好，获得了店长的称赞</td>
          </tr>
          <tr>
            ...
            <td bgcolor="#FFFFFF" class="td2"></td>
                       ...
                       <tr>
            <th colspan="2"  class="td1" style="text-align:left"><strong>福建汇兴汽修有限公司</strong> - 人事实习生</th>
          </tr>
          <tr>
            <th width="80" align="right" class="td1">起止日期：</th>
          ...
          <tr>
            <th align="right"  class="td1">企业名称：</th>
            <td bgcolor="#FFFFFF" class="td2">福建汇兴汽修有限公司</td>
          </tr>
          <tr>
            <th align="right" class="td1">从事职位：</th>
            <td bgcolor="#FFFFFF" class="td2">人事实习生</td>
          </tr>
          <tr>
            <th align="right" class="td1">业绩表现：</th>
            <td bgcolor="#FFFFFF" class="td2">在实习期间内，认真完成各位前辈布置的任务，在工作中认真负责，工作态度十分积极</td>
          </tr>
          <tr>
            <th align="right"  class="td1">企业介绍：</th>
            <td bgcolor="#FFFFFF" class="td2"></td>
      ...
      <div class="c0">
        <table  border="0" align="center" cellpadding="7" cellspacing="1" bgcolor="#CCCCCC" class="resume_show">
          	      		  <tr>
            <th colspan="2" class="td1" style="text-align:left"><strong>Tcl公司</strong> - 关于销售技巧的培训</th>
          </tr>
          <tr>
            <th width="80" align="right" class="td1">起止日期：</th>
            <td class="td2" bgcolor="#FFFFFF">2012年10月至2012年10月</td>
          </tr>
          <tr>
            <th align="right"  class="td1" >培训机构：</th>
            <td class="td2" bgcolor="#FFFFFF">Tcl公司</td>
          </tr>
          <tr>
            <th align="right" class="td1">培训课程：</th>
            <td class="td2" bgcolor="#FFFFFF">关于销售技巧的培训</td>
          </tr>
          <tr>
            <th align="right" class="td1">培训描述：</th>
            <td class="td2" bgcolor="#FFFFFF">通过这次的培训，我学到了很多在销售过程中应该如何提高成交率的一些技巧，让我收获很大</td>
          </tr>
		     	                    </table>
      </div>
    </div>
