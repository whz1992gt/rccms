...
$(document).ready(function()
{
	...
	dialog("加为好友","url:get?/user/user_buddy.php?tuid=4","350px","auto","");
	});
	$("#addpms").click(function(){
	var url="/user/user_pms.php?tuid=4";
  ...
  <tr>
	...
	<a href="javascript:void(0)" id="newbuddy">加为好友</a>
      ...
      <table cellpadding="0" cellspacing="0" style="width:100%">
          <td style="width:80%" class="title"><h1>李苗苗的个人简历</h1>
        ...
        <tr>
          <td><table cellpadding="0" cellspacing="0" style="width:100%">
              ...
              <tr>
                ...
                <td class="td-r">李苗苗</td>
                <td class="td-l">性　　别：</td>
                <td class="td-r">女</td>
              </tr>
              <tr>
                <td class="td-l">年　　龄：</td>
                <td class="td-r">40 岁</td>
                <td class="td-l">身　　高：</td>
                <td class="td-r">160CM</td>
              </tr>
              <tr>
    ...
    <div id="resume">
      ...
      <div class="c1">
        <table cellpadding=0 cellspacing=0 border=0>
          <tr>
            ...
            <td class=td2>本人沟通能力强，性格开朗，品质意识强，为人真诚，有较强的责任心和自信心，能及时完成上级领导安排的工作，接受能力强，有较强的集体荣誉感，具有一定的创新能力和独立自主的能力，我相信学历只是代表过去，而学习力代表现在和未来。<br />
      ...
      <div class="c0">
        <table cellpadding="0" cellspacing="0" border="0">
		           <tr>
            <th colspan="2" class="td1" style="text-align:left"><strong>湖北省仙桃市实验高级中学 </strong>(中专)</th>
          </tr>
          <tr>
            <th width="80" align="right" class="td1">起止年月：</th>
            <td bgcolor="#FFFFFF" class="td2">2004年5月至至今&nbsp;</td>
          </tr>
          <tr>
            <th align="right" class="td1" >学校名称：</th>
            <td bgcolor="#FFFFFF" class="td2">湖北省仙桃市实验高级中学</td>
          </tr>
          <tr>
      ...
      <div class="c0">
        <table  cellpadding="0" cellspacing="0" border="0">
		    	                   <tr>
            <th colspan="2"  class="td1" style="text-align:left"><strong>鸿硕精密电工（苏州）有限公司</strong> - 品保</th>
          </tr>
          <tr>
            <th width="80" align="right" class="td1">起止日期：</th>
            <td bgcolor="#FFFFFF" class="td2">2006年5月至至今&nbsp;</td>
          </tr>
          <tr>
            <th align="right"  class="td1">企业名称：</th>
            <td bgcolor="#FFFFFF" class="td2">鸿硕精密电工（苏州）有限公司</td>
          </tr>
          <tr>
            <th align="right" class="td1">从事职位：</th>
            <td bgcolor="#FFFFFF" class="td2">品保</td>
          </tr>
          <tr>
