...
$(document).ready(function()
{
	...
	dialog("加为好友","url:get?/user/user_buddy.php?tuid=7897","350px","auto","");
	});
	$("#addpms").click(function(){
	var url="/user/user_pms.php?tuid=7897";
  ...
  <tr>
	...
	<a href="javascript:void(0)" id="newbuddy">加为好友</a>
      ...
      <table cellpadding="0" cellspacing="0" style="width:100%">
          <td style="width:80%" class="title"><h1>wdl的个人简历</h1>
            <div class="res-info">更新时间：2014-07-30　会员编号：17207 　浏览次数：<span class="click"></span> 次</div></td>
    ...
    <div id="resume">
      ...
      <div class="c0 m-t">
        ...
        <table cellpadding="0" cellspacing="0" border="0">
          ...
          <tr>
            ...
            <td class="td2">5000~10000元/月</td>
          </tr>
          <tr>
            <td class="td1">期望从事的岗位：</td>
            <td class="td2">营销总监,软件项目经理/主管</td>
          </tr>
          <tr>
            <td class="td1">期望从事的行业：</td>
            <td class="td2">计算机软件/硬件</td>
          </tr>
        </table>
      </div>
      ...
      <div class="c1">
        <table cellpadding=0 cellspacing=0 border=0>
          <tr>
            ...
            <td class=td2>1111111111111111111111111111111111111111111111111111111111111111111
</td>
          </tr>
        </table>
      </div>
      ...
      <div class="c0">
        <table cellpadding="0" cellspacing="0" border="0">
		           <tr>
            <th colspan="2" class="td1" style="text-align:left"><strong>福建工程学院 </strong>(本科)</th>
          </tr>
          <tr>
            <th width="80" align="right" class="td1">起止年月：</th>
            <td bgcolor="#FFFFFF" class="td2">2010年9月至2014年6月&nbsp;</td>
          </tr>
          <tr>
            <th align="right" class="td1" >学校名称：</th>
            <td bgcolor="#FFFFFF" class="td2">福建工程学院</td>
          </tr>
          <tr>
            <th align="right" class="td1">专业名称：</th>
            <td bgcolor="#FFFFFF" class="td2">软件工程</td>
          </tr>
          <tr>
