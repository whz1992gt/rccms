...
$(document).ready(function()
{
	...
	dialog("加为好友","url:get?/user/user_buddy.php?tuid=3","350px","auto","");
	});
	$("#addpms").click(function(){
	var url="/user/user_pms.php?tuid=3";
  ...
  <tr>
	...
	<a href="javascript:void(0)" id="newbuddy">加为好友</a>
      ...
      <table cellpadding="0" cellspacing="0" style="width:100%">
          <td style="width:80%" class="title"><h1>张晓丽的个人简历</h1>
        ...
        <tr>
          <td><table cellpadding="0" cellspacing="0" style="width:100%">
              ...
              <tr>
                ...
                <td class="td-r">张晓丽</td>
                <td class="td-l">性　　别：</td>
                <td class="td-r">女</td>
              </tr>
              <tr>
                <td class="td-l">年　　龄：</td>
                <td class="td-r">29 岁</td>
    ...
    <div id="resume">
      ...
      <div class="c1">
        <table cellpadding=0 cellspacing=0 border=0>
          <tr>
            ...
            <td class=td2>工作认真，刻苦，诚实，有上进心的人。有很强的团结精神。<br />
      ...
      <div class="c0">
        <table cellpadding="0" cellspacing="0" border="0">
		           <tr>
            <th colspan="2" class="td1" style="text-align:left"><strong>南通农业职业技术学院 </strong>(本科)</th>
          </tr>
          <tr>
            <th width="80" align="right" class="td1">起止年月：</th>
            <td bgcolor="#FFFFFF" class="td2">2003年5月至至今&nbsp;</td>
          </tr>
          <tr>
            <th align="right" class="td1" >学校名称：</th>
            <td bgcolor="#FFFFFF" class="td2">南通农业职业技术学院</td>
          </tr>
          <tr>
      ...
      <div class="c0">
        <table  cellpadding="0" cellspacing="0" border="0">
		    	                   <tr>
            <th colspan="2"  class="td1" style="text-align:left"><strong>合肥捷通信息技术有限责任公司</strong> - 销售</th>
          </tr>
          <tr>
            <th width="80" align="right" class="td1">起止日期：</th>
            <td bgcolor="#FFFFFF" class="td2">2006年3月至至今&nbsp;</td>
          </tr>
          <tr>
            <th align="right"  class="td1">企业名称：</th>
            <td bgcolor="#FFFFFF" class="td2">合肥捷通信息技术有限责任公司</td>
          </tr>
          <tr>
