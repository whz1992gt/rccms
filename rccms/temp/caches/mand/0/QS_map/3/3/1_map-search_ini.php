...
<div class="mapnav">
  ...
  <div class="fdiv " ><a href="/jobs/map-search.php?id=1" >视野内搜索</a></div>
   ...
   <div class="fdiv select"><a href="/jobs/map-search.php?id=3" class="a2">按地区搜索</a></div>
  ...
  <div class="right">
		...
		<div class="typebox">
		    ...
		    <div class="searchinput">
				<div>
				<input name="district_cn" type="text" value="请选择地区"  readonly="true" id="district_cn" class="selectinput"/>
