...
<div class="mapnav">
  ...
  <div class="fdiv " ><a href="/jobs/map-search.php?id=1" >视野内搜索</a></div>
   <div class="fdiv select"><a href="/jobs/map-search.php?id=2" class="a1">按职位搜索</a></div>
...
<div class="map">
  ...
  <div class="right">
		...
		$(document).ready(function()
		{
		OpenCategory("#category_cn","#category_cn","#jobcategory","/",12,"");
		});
		</script>
		<div class="typebox">
		    ...
		    <div class="searchinput">
				<div>
				<input name="category_cn" type="text" value="请选择职位类别"  readonly="true" id="category_cn" class="selectinput"/>
