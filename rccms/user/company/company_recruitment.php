...
if ($act=='apply_jobs')
{
	...
	$smarty->display('member_company/company_apply_jobs.ini');
}
...
elseif ($act=='down_resume_lsit')
{
	...
	$smarty->assign('page',$page->show(3));
	$smarty->display('member_company/company_down_resume.ini');
}
...
elseif ($act=='favorites_list')
{
	...
	$smarty->assign('page',$page->show(3));
	$smarty->display('member_company/company_favorites.ini');
}
...
elseif ($act=='interview_lsit')
{
	...
	$smarty->assign('jobs',get_auditjobs($_SESSION['uid']));
	$smarty->assign('page',$page->show(3));
	$smarty->display('member_company/company_interview.ini');
}
//删除面试邀请信息
