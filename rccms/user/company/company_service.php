...
if ($act=='points_report')
{
	...
	$smarty->display('member_company/company_points_report.ini');
}
elseif ($act=='setmeal_report' && $_CFG['operation_mode']=="2")
{
	...
	$smarty->assign('report',get_user_report($offset, $perpage,$wheresql));
	$smarty->assign('page',$page->show(3));
	$smarty->display('member_company/company_setmeal_report.ini');
}
elseif ($act=='order_list')
{
	...
	$smarty->display('member_company/company_order_list.ini');
}
elseif ($act=='points_rule')
{
	...
	$smarty->display('member_company/company_points_rule.ini');
}
elseif ($act=='order_add')
{
	...
	$smarty->assign('points',get_user_points($_SESSION['uid']));
	$smarty->display('member_company/company_order_add.ini');
}
...
elseif ($act=='payment')
{
	...
	$smarty->display('member_company/company_order_pay.ini');
}
...
elseif ($act=='setmeal_list'  && $_CFG['operation_mode']=="2")
{
	...
	$smarty->display('member_company/company_setmeal_list.ini');
}
elseif ($act=='setmeal_order_add'  && $_CFG['operation_mode']=="2")
{
	$smarty->assign('setmeal',get_setmeal(true));
	$smarty->assign('payment',get_payment());
	$smarty->display('member_company/company_order_add_setmeal.ini');
}
...
elseif ($act=='feedback')
{
	...
	$smarty->display('member_company/company_feedback.ini');
}
elseif ($act=='gifts')
{
	...
	$smarty->display('member_company/company_gifts.ini');
}
