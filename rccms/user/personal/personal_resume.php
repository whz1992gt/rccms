...
if ($act=='resume_show')
{
	...
	$smarty->display('member_personal/personal_resume.ini');
}
elseif ($act=='refresh')
{
...
elseif ($act=='resume_list')
{
	...
	$smarty->display('member_personal/personal_resume_list.ini');
}
//创建简历-基本信息
elseif ($act=='make1')
{
	...
	$smarty->display('member_personal/personal_resume_make1.ini');
}
//创建简历 -保存基本信息
...
elseif ($act=='make2')
{
	...
	$smarty->assign('title','我的简历 - 个人会员中心 - '.$_CFG['site_name']);
	$smarty->assign('go_resume_show',$_GET['go_resume_show']);
	$smarty->display('member_personal/personal_resume_make2.ini');
}
//保存-求职意向
...
elseif ($act=='make3')
{
	...
	$smarty->assign('title','我的简历 - 个人会员中心 - '.$_CFG['site_name']);
	$smarty->assign('go_resume_show',$_GET['go_resume_show']);
	$smarty->display('member_personal/personal_resume_make3.ini');
}
...
elseif ($act=='make4')
{
	...
	$smarty->assign('title','我的简历 - 个人会员中心 - '.$_CFG['site_name']);
	$smarty->assign('go_resume_show',$_GET['go_resume_show']);
	$smarty->display('member_personal/personal_resume_make4.ini');
}
//创建简历-保存教育经历
...
elseif ($act=='edit_education')
{
	...
	$smarty->display('member_personal/personal_resume_education_edit.ini');
}
//保存修改的教育经历
...
elseif ($act=='make5')
{
	...
	$smarty->assign('go_resume_show',$_GET['go_resume_show']);
	$smarty->assign('title','我的简历 - 个人会员中心 - '.$_CFG['site_name']);
	$smarty->display('member_personal/personal_resume_make5.ini');
}
//创建简历-保存添加的工作经历
...
elseif ($act=='edit_work')
{
	...
	$smarty->assign('title','编辑简历 - 个人会员中心 - '.$_CFG['site_name']);
	$smarty->display('member_personal/personal_resume_work_edit.ini');
}
...
elseif ($act=='make6')
{
	...
	$smarty->assign('title','我的简历 - 个人会员中心 - '.$_CFG['site_name']);
	$smarty->assign('go_resume_show',$_GET['go_resume_show']);
	$smarty->display('member_personal/personal_resume_make6.ini');
}
//保存-添加的培训经历
...
elseif ($act=='edit_training')
{
	...
	$smarty->assign('title','编辑简历 - 个人会员中心 - '.$_CFG['site_name']);
	$smarty->display('member_personal/personal_resume_training_edit.ini');
}
...
elseif ($act=='make7')
{
	...
	$smarty->assign('pid',$pid);
	$smarty->assign('title','编辑简历 - 个人会员中心 - '.$_CFG['site_name']);
	$smarty->display('member_personal/personal_resume_make7.ini');
}
...
elseif ($act=='photo_cutting')
{
	...
	$smarty->display('member_personal/personal_resume_photo_cutting.ini');
}
//保存-裁切照片
...
elseif ($act=='resume_privacy')
{
	...
	$smarty->assign('resume_basic',$resume_basic);
	$smarty->assign('pid',$pid);
	$smarty->display('member_personal/personal_resume_privacy.ini');
}
...
elseif ($act=='tpl')
{
	...
	$smarty->display('member_personal/personal_resume_tpl.ini');
}
elseif ($act=='tpl_save')
{
	$link[0]['text'] = "查看简历";
...
elseif ($act=='talent')
{
	...
	$smarty->display('member_personal/personal_talent.ini');
}
